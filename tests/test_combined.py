...
def test_calculate_fuel_consumption_combined_model_runs(make_combined_model_case):
    ...
    for r_cruise in cruise_ranges:
        ...
        result = calculate_fuel_consumption_combined_model(
            ...
            dict_climb_segments_origin_to_destination=input_data[
                "dict_climb_segments_origin_to_destination"
            ],
            dict_descent_segments_origin_to_destination=input_data[
...
def test_calculate_fuel_consumption_combined_model_positive_values(
    make_combined_model_case,
):
    make_case, cruise_ranges = make_combined_model_case
