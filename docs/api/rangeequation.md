!!! info
    ...
    | $TSFC, h, V$ | $m, L/D$ | low-speed drag polar applies $C_D = C_{D_0} + KC_L^2$ | "arctan solution" or "constant altitude and airspeed flight schedule" | [`jetfuelburn.rangeequation.calculate_fuel_consumption_arctan`][] |
    ...
    Note that some authors spell "Breguet" as "Bréguet" (with accent on the "e"). This is not limited to non-French speakers. 
