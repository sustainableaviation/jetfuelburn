...
list_data_A330 = [
    usdot.calculate_fuel_consumption_per_seat(
        year=2018,
        acft='Airbus Industrie A330-200',
        R=range * ureg.km
    ).magnitude for range in list_range
]
list_data_B757 = [
...
list_data_A350 = [
    usdot.calculate_fuel_consumption_per_seat(
        year=2018,
        acft='Airbus Industrie A350-900',
        R=range * ureg.km
    ).magnitude for range in list_range
]
list_data_B787 = [
...
with open('/Users/michaelweinold/github/jetfuelburn/dev/homepage/usdot_fuel_burn.csv', mode='w', newline='') as file:
